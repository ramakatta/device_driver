#ifndef _MY_CHAR_DEVICE_H_
#define _MY_CHAR_DEVICE_H_
...
/* MY_FILL_ZERO: to fill our character array with zeros
...
*/
#define MY_FILL_ZERO		_IO( MY_MAGIC, 1 )

/* MY_FILL_ZERO: to fill our character array with a character
   As we can see there is not data transfer. The moment
   our driver gets this command, it executes the following
   for loop
...
*/
#define MY_FILL_CHAR		_IOW( MY_MAGIC, 2, char )

/* MY_SET_SIZE: to set the size of the character array */

#define MY_SET_SIZE		_IOW( MY_MAGIC, 3, uint )

/* MY_GET_SIZE: to get the size of the character array */
#define MY_GET_SIZE		_IOR( MY_MAGIC, 4, uint )
#define MY_ENCRYPT		_IOW( MY_MAGIC, 5, char )
#define MY_DECRYPT		_IOW( MY_MAGIC, 6, char )

#define MY_MAX_CMDS		6

#endif /* _MY_CHAR_DEVICE_H_ */
